 ...
 <div class="hotel_headline"><?php echo $model->Hotels->title;?></div>
  ...
  <div class="hotel_ydleft"><!--hot_ydleft-->
    ...
    <td><label>
     ...
     </label>间 ×¥ <span id="sigle_price"><?php echo $model->price;?>（单间总价） =<strong class="hotel_yprice">¥<span id="total_price"></span></strong><br/><font color="#ff0000"><?php echo $model->price_desc;?></font></td>
