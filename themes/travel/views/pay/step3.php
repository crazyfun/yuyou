<div class="main_con">
    ...
    <div class="order_main">
        ...
        <tbody>
         ...
         <?php if(!empty($model->Travel->coupon)){ 
         	       $user_conpon=0;
         	       if(!Yii::app()->user->isGuest){
         	       	  $user_id=Yii::app()->user->id;
         	       	  $user=User::model();
         	       	  $user_data=$user->findByPk($user_id);
         	       	  $user_conpon=$user_data->conpon;
         	       }
         	?>
         ...
         <table class="orderpro_list">
          <thead>
            <tr>
              <th class="col2">名称</th><th class="col1">可抵用余额</th><th class="col3">当前余额 </th>
              <th class="col4">操作</th><th class="col5">小计</th>
           </tr>
         </thead>
        <tbody>
          <tr>
            <td class="col2">抵用劵（可优惠<?php echo $model->Travel->coupon;?>元/人）</td>
            <td class="col1"><strong>¥<?php echo $model->Travel->coupon;?></strong></td>
            <td class="col3"><strong>¥<?php echo $user_conpon;?></strong></td>
            <td class="col4"><a target="_blank" href="<?php echo $this->createUrl('user/pay');?>">充值</a></td>
            <td class="col5"><strong>抵用<input name="coupon" min="0" max="<?php echo $model->Travel->coupon;?>" type="text" class="coupon_value"/>元</strong></td>
           </tr>
           </tbody>
           </table>
         <!--//优惠信息-->
       ...
       ?>
        ...
        <tbody>
         ...
         ?>
          ...
          <thead>
            <tr>
              <th class="col2">门市名称</th><th class="col2">门市地址</th><th class="col5">联系电话</th>
           </tr>
         </thead>
        <tbody>
        	 <tr>
            <td class="col2"><?php echo $company_data->company_name;?></td>
