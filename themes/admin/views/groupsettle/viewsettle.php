<div id="page_content">
    ...
    <!--用户操作-->
    	<div><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("groupsettle/index");?>">返回到结算管理</a></span></div></div>
    <!--用户操作end-->
    <!--编辑框-->	
    	<div class="edit_content">
    		<?php 
    		  $company_id=$groud_data->company_id;
         ...
         echo CHtml::hiddenField("group_id",$model->group_id,array());
        ?>
           <div class="operate_result"><?php $this->widget("FlashInfo");?></div>
           <div class="content_inline"><div class="content_name">供应商:</div><div class="content_content"><?php echo $company_data->company_name;?></div><div class="content_error"></div></div>
           ...
           <div class="content_inline"><div class="content_name">总价:</div><div class="content_content"><?php echo $groud_data->get_all_price($groud_data->id);?></div><div class="content_error"></div></div>
           <div class="content_inline"><div class="content_name">结算利率:</div><div class="content_content">
           	<?php
           	  $sys_config=SysConfig::model();
	            $sfc_group_settle=$sys_config->get_syscfg_val("sfc_group_settle");
           	  echo $sfc_group_settle['sfc_group_settle'];
           	?></div><div class="content_error"></div></div>
           <div class="content_inline"><div class="content_name">总结算:</div><div class="content_content"><?php echo $groud_data->get_all_settle_price($groud_data->id);?></div><div class="content_error"></div></div>
           ...
           <?php if($model->status=='1'||empty($model->status)){ ?>
             <div class="content_inline"><div class="content_name">结算银行流水号:</div><div class="content_content"><?php echo $form->createText($model,"out_serial",array());?></div><div class="content_error"><?php echo $form->error($model,"out_serial");?></div></div>
             <div class="content_inline"><div class="content_name">备注:</div><div class="content_content"><?php echo $form->createTextarea($model,"comment",array());?></div><div class="content_error"><?php echo $form->error($model,"comment");?></div></div>
	           <div class="content_button"><input type="submit" class="input_submit" value="申请结算" name="button_ok"/></div>
	       <?php }else{ ?>
