<?php 
       ...
       $regions_datas=Util::com_search_item(array(''=>'不限','-1'=>'主站'),$regions_datas);
       $admin_status=Util::com_search_item(array(''=>'管理员'),CV::$admin_status);
       $founder=Util::com_search_item(array(''=>'创始人'),CV::$founder);
          ...
          'attributes'=>array(
            ...
            array(
             ...
             array(
              'name'=>'founder',
              'type'=>'raw',
              'value'=>'$data->show_attribute("founder")'
