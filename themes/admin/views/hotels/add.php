<?php 
  ...
  $channels_select=$channels->get_channel_select('0','0',"hotels");
...
<div id="page_content">
    ...
    <!--用户操作-->
    	<div class=""><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("index",array());?>">返回到酒店管理</a></span><span><a href="<?php echo $this->createUrl("add",array('channel_id'));?>">新增酒店</a></span></div></div>
    <!--用户操作end-->
    <!--编辑框-->	
