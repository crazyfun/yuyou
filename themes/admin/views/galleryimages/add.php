<div id="page_content">
    ...
    <!--用户操作-->
    	<div><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("galleryimages/index",array('gallery_id'=>$model->gallery_id));?>">返回到图片管理</a></span></div></div>
    <!--用户操作end-->
    <!--编辑框-->	
        ...
        ?>
           ...
           <div class="content_inline"><div class="content_name">选择图片</div><div>
	         ...
	         <div class="content_button"><input type="button" onclick="javascript:submit_gallery_images();" class="input_submit" value="确定" name="button_ok"/><input type="reset" class="input_cancel" value="取消" name="button_reset"/></div>
    	<?php $this->endWidget(); ?>
    	</div>
      <!--编辑框end-->	
    </div>
 ...
 <script language="javascript">
    	   ...
    	   function submit_gallery_images(){
