<?php 
   ...
   <div class="im_left">
	 ...
	 <div class="im_right">
     <div id="viewDiv" style="width:200px; height:200px;overflow:hidden;"></div>
	    ...
	    jQuery('#crop_x').val(selection.x1);
	  	...
	  	var scaleY = 200/ (selection.height || 1); 
	  	   jQuery('#viewDiv > img').css({ 
	  	   	  width: Math.round(scaleX * parseInt(jQuery('#myimg').attr('width'))) + 'px', 
		  		  height: Math.round(scaleY * parseInt(jQuery('#myimg').attr('height'))) + 'px', 
