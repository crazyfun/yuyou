...
<div id="page_content">
    ...
    <!--编辑框-->	
    	<div class="edit_content">
           ...
           <div class="content_inline">
           	 <div class="content_name">团购商家</div>
           	 <div class="content_content"><?php echo $form->createAuto($model,"company_id",$model->show_attribute("company_id"),array('serviceUrl'=>'/admin.php/main/company/type/5'));?></div>
           	 <div class="content_error"><?php echo $form->error($model,'company_id');?></div>
           </div>
           
            <div class="content_inline">
           	 <div class="content_name">现价</div>
           	 <div class="content_content"><?php echo $form->createNumber($model,'price',array());?></div>
           	 <div class="content_error"><?php echo $form->error($model,'price');?></div>
           </div>
           
           <div class="content_inline">
           	 <div class="content_name">原价</div>
           	 <div class="content_content"><?php echo $form->createNumber($model,'o_price',array());?></div>
           	 <div class="content_error"><?php echo $form->error($model,'o_price');?></div>
           </div>
           
            <div class="content_inline">
           	 <div class="content_name">成团人数</div>
           	 <div class="content_content"><?php echo $form->createNumber($model,'group',array());?></div>
           	 <div class="content_error"><?php echo $form->error($model,'group');?></div>
           </div>
           
            <div class="content_inline">
           	 <div class="content_name">开始时间</div>
           	 <div class="content_content"><?php echo $form->createDate($model,'start_time',array('dateFmt'=>'yyyy-MM-dd HH:00:00'));?></div>
           	 <div class="content_error"><?php echo $form->error($model,'start_time');?></div>
           </div>
           
           <div class="content_inline">
           	 <div class="content_name">结束时间</div>
           	 <div class="content_content"><?php echo $form->createDate($model,'end_time',array('dateFmt'=>'yyyy-MM-dd HH:00:00'));?></div>
           	 <div class="content_error"><?php echo $form->error($model,'end_time');?></div>
           </div>
           
            <div class="content_inline">
           	 <div class="content_name">过期时间</div>
           	 <div class="content_content"><?php echo $form->createDate($model,'user_time',array('dateFmt'=>'yyyy-MM-dd HH:mm:ss'));?></div>
           	 <div class="content_error"><?php echo $form->error($model,'user_time');?></div>
           </div>
           ...
           <div class="content_inline">
            ...
            <div class="content_inline">
           	 ...
           	 <div class="content_content">
           	 	<?php echo $form->createAjaxselect($model,"end_region_id",array('title'=>'可直接选择城市或输入城市','type_value'=>'region','tabs'=>"[{'name':'城市','url':'/api/region','id':'','type':'region'}]",'serviceUrl'=>"/api/mixregion",'multi'=>false,'level'=>3));?>    
        	  </div>
           	 <div class="content_error"><?php echo $form->error($model,'end_region_id');?></div>
           </div>
           ...
           <div class="content_inline">
           	 <div class="content_name">团购内容</div>
            ...
            <div class="content_inline">
           	 <div class="content_name">简短内容</div>
