<div id="page_content">
    ...
    <!--用户操作-->
    	<div><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("ghotelssettle/index");?>">返回到结算管理</a></span></div></div>
    <!--用户操作end-->
    <!--编辑框-->	
    	<div class="edit_content">
    		<?php 
    		  $company_id=$travel_order_data->Hotels->company_id;
        ...
        ?>
          ...
          <div class="content_inline"><div class="content_name">银行名称:</div><div class="content_content"><?php echo $company_data->bank_name;?></div><div class="content_error"></div></div>
           ...
           <div class="content_inline"><div class="content_name">订单总价:</div><div class="content_content"><?php echo $hotels_order_data->total_price;?></div><div class="content_error"></div></div>
           <div class="content_inline"><div class="content_name">总结算:</div><div class="content_content"><?php echo $hotels_order_data->get_total_settle_price($hotels_order_data->id);?></div><div class="content_error"></div></div>
