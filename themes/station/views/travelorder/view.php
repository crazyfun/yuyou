<div class="order_main">
         ...
         <table class="orderpro_list">
          <thead>
            <tr>
              <th class="col2">线路名称</th><th class="col1">出发时间</th><th class="col3">出发地</th><th class="col3">目的地</th><th class="col3">总价</th><th class="col3">需支付</th><th class="col3">抵用劵</th>
   	...
   	<h3>联系人信息</h3>
        ...
        <tbody>
         ...
         <table class="orderpro_list">
          <thead>
            <tr>
              <th class="col2">门市名称</th><th class="col5">门市地址</th><th class="col1">联系电话</th><th class="col2">订单备注</th> 
           </tr>
         </thead>
        <tbody>
...
<div class="order_print_wrapper"><a href="javascript:void('0')" onclick="javascript:window.open('<?php echo $this->createUrl("travelorder/print",array('id'=>$model->id));?>','打印订单','alwaysRaised=yes,scrollbars=yes,location=yes,status=yes,resizable=yes,toolbar=yes,menubar=yes');" class="print_button">打印订单</a></div>