<div id="page_content">
    ...
    <!--编辑框-->	
        ...
        ?>
           ...
           <div class="content_inline"><div class="content_name">总价:</div><div class="content_content"><?php echo $group_data->get_all_price($group_data->id);?></div><div class="content_error"></div></div>
           ...
           <div class="content_inline"><div class="content_name">总结算:</div><div class="content_content"><?php echo $group_data->get_all_settle_price($group_data->id);?></div><div class="content_error"></div></div>
