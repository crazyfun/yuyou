        ...
        <div class="composer_fields">
        	...
        	<dl>
             <dt><font color="#ff0000">*</font>&nbsp;收件人：</dt>
        	   <dd><?php echo $form->createAuto($model,"user_id",$user_name,array('serviceUrl'=>$this->createUrl('main/searchstationuser'),'class'=>'inputtext'));?><?php echo $form->error($model,"user_id");?>
        	   </dd>
