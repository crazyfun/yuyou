<div id="page_content">
    ...
    <!--用户操作-->
    	<div><div class="user_operate_content"><span><a href="<?php echo $this->createUrl("hotelssettle/index");?>">返回到结算管理</a></span></div></div>
    <!--用户操作end-->
    <!--编辑框-->	
    	<div class="edit_content">
    		<?php 
    		  $company_id=$hotels_order_data->company_id;
