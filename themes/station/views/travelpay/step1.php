...
<div class="main_con">
    ...
    <div class="order_main">
        ...
        <tbody>
          <tr>
            <td class="col1"><?php echo $travel_data->get_admin_date_select($travel_data->id);?></td>
            ...
            <td class="col4">¥<strong id="travel_adult_price"></strong></td>
           ...
           <td class="col7"><span>¥</span><strong class="total" class="travel_total_price" id="travel_total_price">0</strong></td>
           </tr>
           </tbody>
           </table><!--//产品信息-->
