<?php
class GrouporderAction extends BaseAction{
   ...
   protected function do_action(){
		...
		if(!empty($title)){
		   array_push($conditions,"Group.title LIKE :title");
		   $params[':title']="%".$title."%";
  	 ...
  	 //生成ActiveDataProvider对象
		...
		$this->display("group_order",array('model'=>$model,'dataProvider'=>$dataProvider,'user_data'=>$user_data,'page_params'=>$page_params,'cssPath'=>$cssPath,'jsPath'=>$jsPath));
  }
