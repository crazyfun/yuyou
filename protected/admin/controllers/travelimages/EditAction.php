  ...
  protected function do_action(){	
  	...
  	if(isset($_POST[$model_name])){
		  ...
		  $this->controller->f(CV::SUCCESS_ADMIN_OPERATE);
			...
			$model_datas=$model->findAll(array('select'=>'t.image_id','condition'=>"t.travel_id=:travel_id AND t.travel_area_id=:travel_area_id",'params'=>array(':travel_id'=>$model->travel_id,':travel_area_id'=>$model->travel_area_id)));
			$image_ids=array();
