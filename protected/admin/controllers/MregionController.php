<?php
class MregionController extends AController
{
	...
	public function actions()
	{
		...
		$controller_path="application.admin.controllers.mregion.";
		return array(
		  ...
		  'children'=>$controller_path.'ChildrenAction',
		  'open'=>$controller_path.'OpenAction',
		);
	}
