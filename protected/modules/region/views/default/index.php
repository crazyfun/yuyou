...
<div class="change_city_con">
            <div class="hotcities">
                <p class="enter_city">进入<a href="<?php echo $this->createUrl("/region/default/set",array('region_id'=>$current_region['id'],'action'=>'select'));?>"><?php echo $current_region['name'];?><span>»</span></a>
                </p><p class="show_hot_city">
                    <span>
                        热门城市：
                        <a href="<?php echo $this->createUrl("/region/default/set",array('region_id'=>'478','action'=>'select'));?>">上海市</a>
                   </span>
                </p>
            </div>
	  ...
	  $form=$this->beginWidget('EActiveForm', array(
	        'id'=>'',
          'action'=>$this->createUrl("default/set"),
                	 ...
                	 <?php foreach($region_datas as $key => $value){
	 	  							...
	 	  							<li>
	 	    								...
	 	    								<?php foreach($children as $key1 => $value1){?>
	 	        								<?php echo CHtml::link($value1['name'],$this->createUrl("default/set",array('region_id'=>$value1['id'],'action'=>'select')),array());?>
        								<?php } ?>
        								</span>
	 	  	                </p>
	 	  							</li>
