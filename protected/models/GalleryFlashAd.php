...
/**
 * This is the model class for table "{{gallery_flash_ad}}".
 *
 * The followings are the available columns in table '{{gallery_flash_ad}}':
 * @property string $id
 * @property string $flash_img
 * @property string $describe
 * @property integer $sort
 */
class GalleryFlashAd extends BaseActive
{
	/**
