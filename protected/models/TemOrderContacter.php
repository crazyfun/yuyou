 ...
 */
class TemOrderContacter extends BaseActive
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('contacter,code_type,code_value', 'required','message'=>'{attribute}不能为空','on'=>'Order'),
			array('contacter,contacter_phone', 'required','message'=>'{attribute}不能为空','on'=>'Main'),
	...
	public function relations()
	{
		...
		return array(
				'TempOrder'=>array(self::BELONGS_TO,'TempOrder','order_id'),
