							<input type="button" class="bnt_up" id="bnt_up" value="我想去"/>
            	<!--顶-->
              <input type="button" class="bnt_down" id="bnt_down" value="我不想去"/>
              <!--踩-->
...
jQuery(function(){
       ...
       jQuery.ajax({
        ...
        success: function(msg){
         if(msg.flag=='1'){
           var datas=msg.datas;
           jQuery("#bnt_up").val("我想去("+datas.goods+")");
           jQuery("#bnt_down").val("我不想去("+datas.bads+")");
         }
        }
      }); 
